      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
          ...
          <div className='flex flex-col'>
            ...
            <div className='rounded-md border overflow-hidden border-gray-300 h-full relative bg-layer '>
              {/* if we have img then we display the image */}
        ...
        {resultImage && <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
          <button className='px-8 py-2.5 text-violet-600 text-sm border border-violet-600 rounded-full hover:scale-105 transition-all duration-700' onClick={()=>navigate('/')}>Try another image</button>
