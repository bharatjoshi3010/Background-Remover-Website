...
const Navbar = () => {
    ...
    const { openSignIn } = useClerk()   //for authentication
  ...
  return (
    <div className='flex items-center justify-between mx-4 py-3 lg:mx-44'>
      ...
      {
        //if signed in then the div otherwise the button
        isSignedIn
        ?<div className='flex items-center gap-2 sm:gap-3 '>
          ...
          <UserButton />
        </div>:<button onClick={()=>openSignIn({})} className='bg-zinc-800 text-white flex items-center gap-4 px-4 py-2 sm:px-8 sm:py-3 text-sm rounded-full cursor-pointer'>
